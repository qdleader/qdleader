...
indent-rainbow 缩进用彩虹颜色高亮，对一些强缩进的比如YAML文件挺好用的

Live Server 启动一个本地服务器，端口默认是5500，代理静态文件夹，自动热更新

Material Icon Theme 让你的文件图标更好看，vscode有些很丑

Open In Default Browse 按Ctrl+1在默认浏览器直接打开单文件html

Path Intellisense 智能提示路径
