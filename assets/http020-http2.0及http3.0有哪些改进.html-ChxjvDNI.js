import{_ as a,e as t,f as h,o as n}from"./app-BTXTvCFM.js";const p={};function r(d,e){return n(),t("div",null,e[0]||(e[0]=[h(`<h1 id="http2-0-及-http3-0-有哪些改进" tabindex="-1"><a class="header-anchor" href="#http2-0-及-http3-0-有哪些改进"><span>http2.0 及 http3.0 有哪些改进</span></a></h1><h2 id="一、http-1-0" tabindex="-1"><a class="header-anchor" href="#一、http-1-0"><span>一、HTTP/1.0</span></a></h2><p>1996 年 5 月，HTTP/1.0 版本发布，为了提高系统的效率，HTTP/1.0 规定浏览器与服务器只保持短暂的连接，浏览器的每次请求都需要与服务器建立一个 TCP 连接，服务器完成请求处理后立即断开 TCP 连接，服务器不跟踪海个客户也不记录过去的请求。 请注意上面提到的 HTTP/1.0 中浏览器与服务器只保持短暂的连接，连接无法复用。也就是说每个 TCP 连接只能发送一个请求。发送数据完毕，连接就关闭，如果还要请求其他资源，就必须再新建一个连接。 我们知道 TCP 连接的建立需要三次握手，是很耗费时间的一个过程。所以，HTTP/1.O 版本的性能比较差。现在，随便打开一个网页，上面都会有很多图片、视频等资源，HTTP/1.0 显然无法满足性能要求。</p><h2 id="二、http-1-1" tabindex="-1"><a class="header-anchor" href="#二、http-1-1"><span>二、HTTP/1.1</span></a></h2><h3 id="_1、持久连接" tabindex="-1"><a class="header-anchor" href="#_1、持久连接"><span>1、持久连接</span></a></h3><pre><code>HTTP/1.0 中一个 TCP 连接只能发送一个请求和响应，而 HTTP/1.1 进行了优化，同一个 TCP 连接可以发送多次 HTTP 请求，减少了建立和关闭连接的性能开销。
...
</code></pre><h6 id="三-自定义的拥塞控制" tabindex="-1"><a class="header-anchor" href="#三-自定义的拥塞控制"><span>三，自定义的拥塞控制</span></a></h6><p>tcp 协议是在传输层，默认存在于系统中，而 QUIC 在应用层，当想要依据实际情况来重定义拥塞算法的时候，QUIC 显然更加灵活。Google 提出了 cubic 和 newreno 提供了许多可供编程的接口。当然，和 tcp 一样，也是默认采用 cubic 算法。</p><p>那么 tcp 的拥塞怎么控制的呢？</p><p>这一块其实知识也挺多，简单来说就是，拥塞窗口前期会指数增加，直到到达一个阈值，然后就开始线性增加，直到出现超时事件，窗口大小到达最大值 MAX。之后窗口调整为初始值，开始同样的增长，阈值减小为 MAX/2。但是超时不一定是因为拥塞，也可能是因为丢包，那怎么办呢？如果从最初开始增加，那么显然会比较慢，等到发送方连续收到 3 个接收方发出的丢包 ACK，直接让窗口大小等于阈值，再线性增长。这也有一个响亮的名字，快速恢复算法。</p><h6 id="四-前向安全和前向纠错" tabindex="-1"><a class="header-anchor" href="#四-前向安全和前向纠错"><span>四，前向安全和前向纠错</span></a></h6><p>都说 udp 不太靠谱，但是 Google 给 QUIC 加上了这个机制：每发送一组数据之后，就对这组数据进行异或运算（效率高），并将结果也发送出去，那么接收方就有两份数据版本，可以对初始数据进行纠错和校验。以此保证了可靠性。</p>`,58)]))}const c=a(p,[["render",r],["__file","http020-http2.0及http3.0有哪些改进.html.vue"]]),l=JSON.parse('{"path":"/http/http020-http2.0%E5%8F%8Ahttp3.0%E6%9C%89%E5%93%AA%E4%BA%9B%E6%94%B9%E8%BF%9B.html","title":"http2.0 及 http3.0 有哪些改进","lang":"zh-CN","frontmatter":{},"headers":[{"level":2,"title":"一、HTTP/1.0","slug":"一、http-1-0","link":"#一、http-1-0","children":[]},{"level":2,"title":"二、HTTP/1.1","slug":"二、http-1-1","link":"#二、http-1-1","children":[{"level":3,"title":"1、持久连接","slug":"_1、持久连接","link":"#_1、持久连接","children":[]},{"level":3,"title":"2、管道机制","slug":"_2、管道机制","link":"#_2、管道机制","children":[]},{"level":3,"title":"3、缓存控制","slug":"_3、缓存控制","link":"#_3、缓存控制","children":[]},{"level":3,"title":"4、断点续传","slug":"_4、断点续传","link":"#_4、断点续传","children":[]}]},{"level":2,"title":"三、HTTP/2.0","slug":"三、http-2-0","link":"#三、http-2-0","children":[{"level":3,"title":"1、头部压缩","slug":"_1、头部压缩","link":"#_1、头部压缩","children":[]},{"level":3,"title":"2、二进制帧","slug":"_2、二进制帧","link":"#_2、二进制帧","children":[]},{"level":3,"title":"3、多路复用","slug":"_3、多路复用","link":"#_3、多路复用","children":[]},{"level":3,"title":"4、服务器主动推送","slug":"_4、服务器主动推送","link":"#_4、服务器主动推送","children":[]}]},{"level":2,"title":"HTTP/3.0（QUIC 协议）","slug":"http-3-0-quic-协议","link":"#http-3-0-quic-协议","children":[]}],"git":{"updatedTime":1741916331000,"contributors":[{"name":"qdleader","username":"qdleader","email":"yk4545945@163.com","commits":1,"url":"https://github.com/qdleader"}],"changelog":[{"hash":"b62ca1fcbdbabd49c9914b486982b403c3c04a60","time":1741916331000,"email":"yk4545945@163.com","author":"qdleader","message":"docs: 添加JS输出类及前置自增与后置自增示例"}]},"filePathRelative":"http/http020-http2.0及http3.0有哪些改进.md"}');export{c as comp,l as data};
