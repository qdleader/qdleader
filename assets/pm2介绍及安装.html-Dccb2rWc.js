import{_ as n,e as a,f as e,o as l}from"./app-Dw20wKhM.js";const p={};function i(t,s){return l(),a("div",null,s[0]||(s[0]=[e(`<h2 id="_1、pm2是什么" tabindex="-1"><a class="header-anchor" href="#_1、pm2是什么"><span>1、PM2是什么</span></a></h2><p>PM2 是一个带有负载均衡功能的 Node 应用的进程管理器。我们都知道nodejs是单进程执行的，当程序出现错误死掉之后需要能够自动，这时候就需要PM2了。当然进程管理工具有很多，例如forever等等；</p><p>入门教程 挑我们最爱的express应用来举例。一般我们都是通过npm start启动应用，其实就是调用node ./bin/www。那么，换成pm2就是 注意，这里用了--watch参数，意味着当你的express应用代码发生变化时，pm2会帮你重启服务，多贴心。 pm2 start ./bin/www --watch</p><h3 id="_2、主要特性" tabindex="-1"><a class="header-anchor" href="#_2、主要特性"><span>2、主要特性</span></a></h3><p>1）启动多子进程，充分使用CPU</p><p>2）子进程之间负载均衡</p><p>3）0秒重启</p><p>4）界面友好</p><p>5）提供进程交互（例如：监控）接口</p><h3 id="_3、安装" tabindex="-1"><a class="header-anchor" href="#_3、安装"><span>3、安装</span></a></h3><div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre><code><span class="line">npm install pm2 <span class="token operator">-</span>g</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><h3 id="_4、使用" tabindex="-1"><a class="header-anchor" href="#_4、使用"><span>4、使用</span></a></h3><div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre><code><span class="line">pm2 start app<span class="token punctuation">.</span>js <span class="token operator">-</span>i <span class="token number">4</span> <span class="token operator">-</span>n customer   <span class="token comment">//-i 4启动4个进程 -n customer指定进程名称</span></span>
