import{_ as e,c as a,a as n,o as i}from"./app-DmMObJTC.js";const l={};function t(r,s){return i(),a("div",null,s[0]||(s[0]=[n(`<h1 id="css实现一个三角形" tabindex="-1"><a class="header-anchor" href="#css实现一个三角形"><span>css实现一个三角形</span></a></h1><p>向上的 等腰 三角形</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">.box {</span>
