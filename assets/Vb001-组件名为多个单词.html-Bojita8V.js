import{_ as s,c as a,a as e,o as l}from"./app-D_ZNEwCJ.js";const i={};function p(c,n){return l(),a("div",null,n[0]||(n[0]=[e(`<h1 id="vb001-组件名为多个单词" tabindex="-1"><a class="header-anchor" href="#vb001-组件名为多个单词"><span>Vb001-组件名为多个单词</span></a></h1><h3 id="组件的命名为多个单词" tabindex="-1"><a class="header-anchor" href="#组件的命名为多个单词"><span>组件的命名为多个单词</span></a></h3><div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre><code><span class="line">#组件名应该始终是多个单词的，根组件 App 以及 <span class="token operator">&lt;</span>transition<span class="token operator">&gt;</span>、<span class="token operator">&lt;</span>component<span class="token operator">&gt;</span> 之类的 Vue 内置组件除外。</span>
