import{_ as n,e,f as a,o as l}from"./app-Co8h00Iv.js";const i={};function c(d,s){return l(),e("div",null,s[0]||(s[0]=[a(`<h1 id="async-eventloop类问题" tabindex="-1"><a class="header-anchor" href="#async-eventloop类问题"><span>async(eventLoop类问题)</span></a></h1><p>下面输出什么？</p><p>eg1:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line"></span>
