import{_ as s,e as a,f as p,o as e}from"./app-BTXTvCFM.js";const i={};function l(t,n){return e(),a("div",null,n[0]||(n[0]=[p(`<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre><code><span class="line">Nginx配置Gzip</span>
...
<span class="line"><span class="token punctuation">}</span><span class="token punctuation">;</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在vite中使用vite-plugin-compression来实现</p><div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre><code><span class="line"><span class="token keyword">import</span> compressPlugin <span class="token keyword">from</span> <span class="token string">&#39;vite-plugin-compression&#39;</span><span class="token punctuation">;</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>gzip_static的优先级高，会先加载静态gz文件，当同目录下不存在此文件的时候，会执行在线压缩命令。</p><h5 id="_3、确定请求资源是否为gzip压缩" tabindex="-1"><a class="header-anchor" href="#_3、确定请求资源是否为gzip压缩"><span>3、确定请求资源是否为gzip压缩？</span></a></h5><p>响应头的Content-Edcoding:gzip表示gzip压缩已经生效 比较文件大小，看请求资源文件大小是否比打包后的资源更小</p><h5 id="_4、确定是否请求的是预打包的gz资源" tabindex="-1"><a class="header-anchor" href="#_4、确定是否请求的是预打包的gz资源"><span>4、确定是否请求的是预打包的gz资源？</span></a></h5><p>Etag中只有简单字符表示静态资源加载，而前面带 W/ 表示启动了在线压缩。</p>`,21)]))}const o=s(i,[["render",l],["__file","Nginx配置gzip.html.vue"]]),r=JSON.parse('{"path":"/%E6%9C%8D%E5%8A%A1%E7%AB%AF/%E5%89%8D%E7%AB%AF%E8%A6%81%E6%87%82%E5%BE%97%E9%83%A8%E5%88%86Nginx/Nginx%E9%85%8D%E7%BD%AEgzip.html","title":"zip压缩的方案有几种？","lang":"zh-CN","frontmatter":{},"headers":[{"level":2,"title":"一、服务器在线Gzip压缩（nginx）","slug":"一、服务器在线gzip压缩-nginx","link":"#一、服务器在线gzip压缩-nginx","children":[]},{"level":2,"title":"二、前端预生成gz文件","slug":"二、前端预生成gz文件","link":"#二、前端预生成gz文件","children":[]},{"level":2,"title":"Gzip两种方式结合","slug":"gzip两种方式结合","link":"#gzip两种方式结合","children":[]}],"git":{"updatedTime":1741916331000,"contributors":[{"name":"qdleader","username":"qdleader","email":"yk4545945@163.com","commits":1,"url":"https://github.com/qdleader"}],"changelog":[{"hash":"b62ca1fcbdbabd49c9914b486982b403c3c04a60","time":1741916331000,"email":"yk4545945@163.com","author":"qdleader","message":"docs: 添加JS输出类及前置自增与后置自增示例"}]},"filePathRelative":"服务端/前端要懂得部分Nginx/Nginx配置gzip.md"}');export{o as comp,r as data};
