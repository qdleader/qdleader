...
<span class="line">subFn(num1.value, num2.value)</span>
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>在Vue3自定义Hooks中，虽然加法和减法Hooks都返回了totalNum，但是利用ES6对象解构很轻松给变量重命名</p></blockquote>`,19)]))}const p=s(i,[["render",d]]),v=JSON.parse('{"path":"/vue3/vue3%E4%B8%AD%E7%9A%84hooks.html","title":"vue3中的hooks","lang":"zh-CN","frontmatter":{},"git":{"updatedTime":1749177393000,"contributors":[{"name":"qdleader","username":"qdleader","email":"yk4545945@163.com","commits":1,"url":"https://github.com/qdleader"}],"changelog":[{"hash":"41449d8f93f1f6d7fcfd30254be1c31d5ee23f86","time":1749177393000,"email":"yk4545945@163.com","author":"qdleader","message":"docs(ai/prompt): 添加UI+Vue开发提示词文档"}]},"filePathRelative":"vue3/vue3中的hooks.md"}');export{p as comp,v as data};
