import{_ as n,c as s,a as e,o as i}from"./app-D_ZNEwCJ.js";const l={};function t(d,a){return i(),s("div",null,a[0]||(a[0]=[e(`<h1 id="小程序中背景音乐getbackgroundaudiomanager使用问题" tabindex="-1"><a class="header-anchor" href="#小程序中背景音乐getbackgroundaudiomanager使用问题"><span>小程序中背景音乐getBackgroundAudioManager使用问题</span></a></h1><h2 id="小程序中背景音乐getbackgroundaudiomanager使用问题-1" tabindex="-1"><a class="header-anchor" href="#小程序中背景音乐getbackgroundaudiomanager使用问题-1"><span>小程序中背景音乐getBackgroundAudioManager使用问题</span></a></h2><h3 id="_1-当你在-onplay方法中写入计时器时候-计时器会没两秒或三秒更新一次" tabindex="-1"><a class="header-anchor" href="#_1-当你在-onplay方法中写入计时器时候-计时器会没两秒或三秒更新一次"><span>1. 当你在 onPlay方法中写入计时器时候，计时器会没两秒或三秒更新一次</span></a></h3><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line"> var manager = wx.getBackgroundAudioManager();</span>
...
<span class="line">  });</span>
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>解决方法是把计时器提出来在别的事件中写</p><p>eg：我在播放按钮时候启动计时器</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">//播放按钮</span>
