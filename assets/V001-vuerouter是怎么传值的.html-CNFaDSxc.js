import{_ as s,c as n,a,o as i}from"./app-JR0DiM0i.js";const l={};function d(t,e){return i(),n("div",null,e[0]||(e[0]=[a(`<h1 id="v001-vuerouter是怎么传值的" tabindex="-1"><a class="header-anchor" href="#v001-vuerouter是怎么传值的"><span>V001-vuerouter是怎么传值的</span></a></h1><ol><li></li></ol><blockquote><p>在路由处配置</p></blockquote><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">path:&#39;/detail/:id&#39;</span>
