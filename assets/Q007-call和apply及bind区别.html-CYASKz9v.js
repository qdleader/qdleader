import{_ as s,c as a,a as l,o as p}from"./app-JR0DiM0i.js";const e={};function i(c,n){return p(),a("div",null,n[0]||(n[0]=[l(`<h1 id="q007-call和apply及bind区别" tabindex="-1"><a class="header-anchor" href="#q007-call和apply及bind区别"><span>Q007-call和apply及bind区别</span></a></h1><div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre><code class="language-javascript"><span class="line"><span class="token keyword">var</span> name <span class="token operator">=</span> <span class="token string">&#39;王&#39;</span><span class="token punctuation">,</span>age<span class="token operator">=</span> <span class="token number">17</span><span class="token punctuation">;</span></span>
