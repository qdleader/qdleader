import{_ as n,e,f as a,o as l}from"./app-BTXTvCFM.js";const i={};function c(d,s){return l(),e("div",null,s[0]||(s[0]=[a(`<p>TS提供给了我们三个修饰符</p><p>public 共有属性 都可以访问到 protected 保护属性 只有这个类的内部和子类中可以访问到 private 私有属性 只有这个类中可以访问到，子类都访问不到</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">class Parent {</span>
