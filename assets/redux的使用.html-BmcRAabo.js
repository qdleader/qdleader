import{_ as n,c as a,a as e,o as i}from"./app-CKfc45Zi.js";const l={};function d(c,s){return i(),a("div",null,s[0]||(s[0]=[e(`<h1 id="redux的使用" tabindex="-1"><a class="header-anchor" href="#redux的使用"><span>redux的使用</span></a></h1><p>redux与vuex一样是一个组件的状态（数据）管理器，当我们需要在项目各组件中共享数据时可以使用。 redux是一个第三方的库，本身和react没有任何关系，react-redux也是一个第三方库，可以帮助我们在react项目中更好的使用redux。</p><h2 id="store-状态库-用于存放组件中的state。" tabindex="-1"><a class="header-anchor" href="#store-状态库-用于存放组件中的state。"><span>store（状态库）：用于存放组件中的state。</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line"></span>
