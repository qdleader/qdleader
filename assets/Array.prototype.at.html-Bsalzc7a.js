import{_ as n,c as s,a as e,o as l}from"./app-ChbYw63X.js";const i={};function r(t,a){return l(),s("div",null,a[0]||(a[0]=[e(`<h1 id="array-prototype-at" tabindex="-1"><a class="header-anchor" href="#array-prototype-at"><span>Array.prototype.at</span></a></h1><h2 id="使用array-prototype-at-简化arr-length" tabindex="-1"><a class="header-anchor" href="#使用array-prototype-at-简化arr-length"><span>使用Array.prototype.at()简化arr.length</span></a></h2><p>Array.prototype.at()接收一个正整数或者负整数作为参数，表示获取指定位置的成员</p><p>参数正数就表示顺数第几个，负数表示倒数第几个，这可以很方便的某个数组末尾的元素</p><p>不存在-0，-0 = 0</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">var arr = [1, 2, 3, 4, 5]</span>
