import{_ as a,e,f as s,g as l,o as i,t as p}from"./app-BTXTvCFM.js";const d={};function c(v,n){return i(),e("div",null,[n[0]||(n[0]=s(`<h1 id="weakmap和map的区别" tabindex="-1"><a class="header-anchor" href="#weakmap和map的区别"><span>WeakMap和Map的区别</span></a></h1><h2 id="map-的使用" tabindex="-1"><a class="header-anchor" href="#map-的使用"><span>map 的使用</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">map.set(key,value)添加键值对到映射中</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果读取一个未知的键，则返回undefined。</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">new Map().get(&#39;asfddfsasadf&#39;)</span>
