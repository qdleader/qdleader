import{_ as s,c as a,a as e,o as l}from"./app-JR0DiM0i.js";const i={};function o(d,n){return l(),a("div",null,n[0]||(n[0]=[e(`<p>1.官网下载地址：www.mongodb.com/try/downloa… 进去之后选择社区版 https://www.mongodb.com/try/download</p><p>下载 MongoDB Community Server 这个版本</p><p>2.将下载好的文件解压缩，重命名为mongodb，</p><p>3.打开访达按 ⬆️+Command+G ，在前往中输入/usr/local， 将重命名的文件放在/usr/local 目录下 4.配置环境变量，打开终端，输入“open -e .bash_profile”： 再打开的文件中输入“export PATH=\${PATH}:/usr/local/mongodb/bin”</p><p>然后输入“source .bash_profile”，使配置立即生效。</p><p>5.输入mongod --version ,看到版本号则说明安装成功。</p><p>6.在/usr/local/mongodb 目录下创建两个文件夹: data 和 log。</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">mkdir data</span>
<span class="line"></span>
<span class="line">mkdir log</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>7.在终端中，先进入data和log所在的目录，也就是/usr/local/mongodb ，然后输入&quot;mongod --dbpath data --logpath log/mongod.log --logappend&quot;，启动mongodb服务(当前终端不要关闭)</p><p>8.在新的终端中输入&quot;mongo&quot; 连接数据库</p><p>mongod --dbpath /usr/local/var/mongodb --logpath /usr/local/var/log/mongodb/mongo.log --fork</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">第8步不生效时候</span>
<span class="line"></span>
