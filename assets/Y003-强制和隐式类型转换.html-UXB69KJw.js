import{_ as n,c as e,a,o as l}from"./app-BIm5By0_.js";const i={};function t(d,s){return l(),e("div",null,s[0]||(s[0]=[a(`<h1 id="y003-强制和隐式类型转换" tabindex="-1"><a class="header-anchor" href="#y003-强制和隐式类型转换"><span>Y003-强制和隐式类型转换</span></a></h1><h2 id="强制" tabindex="-1"><a class="header-anchor" href="#强制"><span>强制:</span></a></h2><p>parseInt(), parseFloat(),toString(), Number(), Boolean(), String(),Math.round() Math.round():严格转换，不允许出现任何非数字的字符，否则NaN；取最接近的整数。 Number():严格转换，不允许出现任何非数字的字符，否则NaN；直接转换</p><h2 id="隐式" tabindex="-1"><a class="header-anchor" href="#隐式"><span>隐式:</span></a></h2><p>if, 逻辑运算, == ,|| &amp;&amp;, + - !</p><h2 id="常见解析" tabindex="-1"><a class="header-anchor" href="#常见解析"><span>常见解析</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">// 1.parseInt() 把值转换成整数</span>
...
<span class="line">&quot;&quot; == []         // true</span>
<span class="line">0 == []          // true</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果两边的值中有true或者false，千万不要使用== 如果两边的值中有[]、&quot;&quot;、或者0，尽量不要使用==</p><p>隐式强制转换在部分情况下确实很危险，为了安全起见就要使用===</p>`,22)]))}const r=n(i,[["render",t]]),u=JSON.parse('{"path":"/%E5%89%8D%E7%AB%AF%E9%9D%A2%E8%AF%95/js%E7%B1%BB/%E8%BF%90%E7%AE%97%E7%B1%BB/Y003-%E5%BC%BA%E5%88%B6%E5%92%8C%E9%9A%90%E5%BC%8F%E7%B1%BB%E5%9E%8B%E8%BD%AC%E6%8D%A2.html","title":"Y003-强制和隐式类型转换","lang":"zh-CN","frontmatter":{},"git":{"updatedTime":1753148857000,"contributors":[{"name":"qdleader","username":"qdleader","email":"yk4545945@163.com","commits":1,"url":"https://github.com/qdleader"}],"changelog":[{"hash":"ac1cf3212b41ab3aca8f411ac8167254f5e148f8","time":1753148857000,"email":"yk4545945@163.com","author":"qdleader","message":"feat: 增加复制文案的兼容写法"}]},"filePathRelative":"前端面试/js类/运算类/Y003-强制和隐式类型转换.md"}');export{r as comp,u as data};
