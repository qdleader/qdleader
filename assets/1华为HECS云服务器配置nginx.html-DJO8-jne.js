import{_ as e,e as s,f as a,o as i}from"./app-BTXTvCFM.js";const r={};function l(t,n){return i(),s("div",null,n[0]||(n[0]=[a(`<h1 id="_1华为hecs云服务器配置nginx" tabindex="-1"><a class="header-anchor" href="#_1华为hecs云服务器配置nginx"><span>1华为HECS云服务器配置nginx</span></a></h1><h2 id="一、安装开发工具和依赖库" tabindex="-1"><a class="header-anchor" href="#一、安装开发工具和依赖库"><span>一、安装开发工具和依赖库</span></a></h2><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code><span class="line">yum <span class="token parameter variable">-y</span> <span class="token function">install</span> <span class="token function">make</span> zlib zlib-devel gcc-c++ libtool  openssl openssl-devel</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><p>上面命令，用于在yum软件包管理器中安装一些开发工具和依赖库。命令中各个参数的含义如下：</p><p>yum：是Linux系统常用的软件包管理工具； -y：表示在安装过程中遇到提示时默认选择&quot;yes&quot;，不需要手动确认； install：表示安装软件包； make：是一个构建工具，能够自动化地进行编译程序等操作； zlib、zlib-devel：都是提供数据压缩和解压功能的开发库，程序在编译时通常需要这两个库的支持； gcc-c++：是C++编译器，可以编译C++程序； libtool：是一个构建工具，在Linux平台上使用较多，能够简化动态库、静态库的构建流程； openssl、openssl-devel：是一个开源的加密库，提供了很多加密和解密函数。</p><h2 id="二、安装pcre" tabindex="-1"><a class="header-anchor" href="#二、安装pcre"><span>二、安装PCRE</span></a></h2><p>在nginx中，PCRE库被用来解析和匹配HTTP请求的URL、header、body等内容，并进行相关的操作，如重定向、路由转发、用户身份验证等。Nginx使用PCRE库能够实现更加灵活和高效的请求匹配和处理，同时也能节省开发者的时间和精力，提高Web应用的性能。因此，可将PCRE视为Nginx的一个重要组件。</p><h4 id="_1、进入-usr-local-src-文件夹下执行命令下载pcre8-45压缩包。" tabindex="-1"><a class="header-anchor" href="#_1、进入-usr-local-src-文件夹下执行命令下载pcre8-45压缩包。"><span>1、进入/usr/local/src/文件夹下执行命令下载pcre8.45压缩包。</span></a></h4><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code><span class="line"> <span class="token builtin class-name">cd</span> /usr/local/src/</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2、解压" tabindex="-1"><a class="header-anchor" href="#_2、解压"><span>2、解压</span></a></h4><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code><span class="line"><span class="token function">tar</span> zxvf pcre-8.45.tar.gz</span>
<span class="line"></span>
<span class="line"></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3、编译安装" tabindex="-1"><a class="header-anchor" href="#_3、编译安装"><span>3、编译安装</span></a></h4><p>进入pcre-8.45目录，进行编译安装 shell复制代码# cd pcre-8.45</p><h1 id="configure" tabindex="-1"><a class="header-anchor" href="#configure"><span>./configure</span></a></h1><p>yum -y install gcc-c++</p><h1 id="make" tabindex="-1"><a class="header-anchor" href="#make"><span>make</span></a></h1><p>make install</p><h4 id="_4、安装完成" tabindex="-1"><a class="header-anchor" href="#_4、安装完成"><span>4、安装完成</span></a></h4><p>输入命令，如果显示对应版本号表示安装成功。 lua复制代码# pcre-config --version</p><h2 id="三、安装nginx" tabindex="-1"><a class="header-anchor" href="#三、安装nginx"><span>三、安装nginx</span></a></h2><h4 id="_1、下载" tabindex="-1"><a class="header-anchor" href="#_1、下载"><span>1、下载</span></a></h4><p>进入/usr/local/src/目录，使用以下命令下载nginx并解压。</p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code><span class="line"> <span class="token builtin class-name">cd</span> /usr/local/src/</span>
<span class="line"><span class="token comment"># wget http://nginx.org/download/nginx-1.23.4.tar.gz</span></span>
<span class="line"><span class="token comment"># tar zxvf nginx-1.23.4.tar.gz</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2、编译安装" tabindex="-1"><a class="header-anchor" href="#_2、编译安装"><span>2、编译安装</span></a></h4><p>进入nginx-1.23.4文件夹输入下面命令编译安装。</p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code><span class="line"><span class="token builtin class-name">cd</span> nginx-1.23.4</span>
...
</code></pre><p>}</p><p>检查配置文件nginx.conf的正确性命令： shell复制代码# /usr/local/webserver/nginx/sbin/nginx -t</p><p>四、启动 Nginx 输入如下命令启动Nginx： shell复制代码# /usr/local/webserver/nginx/sbin/nginx</p><p>使用浏览器访问我们配置的网站ip，页面显示 Welcome to Nginx！，恭喜您已经成功启动nginx。</p><p>// 修改配置文件 vim /usr/local/webserver/nginx/conf/nginx.conf</p><p>//停止<br> /usr/local/webserver/nginx/sbin/nginx -s stop</p><p>// 启动 /usr/local/webserver/nginx/sbin/nginx</p>`,42)]))}const p=e(r,[["render",l],["__file","1华为HECS云服务器配置nginx.html.vue"]]),o=JSON.parse('{"path":"/%E6%9C%8D%E5%8A%A1%E7%AB%AF/%E5%89%8D%E7%AB%AF%E8%A6%81%E6%87%82%E5%BE%97%E9%83%A8%E5%88%86Nginx/1%E5%8D%8E%E4%B8%BAHECS%E4%BA%91%E6%9C%8D%E5%8A%A1%E5%99%A8%E9%85%8D%E7%BD%AEnginx.html","title":"1华为HECS云服务器配置nginx","lang":"zh-CN","frontmatter":{},"headers":[{"level":2,"title":"一、安装开发工具和依赖库","slug":"一、安装开发工具和依赖库","link":"#一、安装开发工具和依赖库","children":[]},{"level":2,"title":"二、安装PCRE","slug":"二、安装pcre","link":"#二、安装pcre","children":[]},{"level":2,"title":"三、安装nginx","slug":"三、安装nginx","link":"#三、安装nginx","children":[]}],"git":{"updatedTime":1741916331000,"contributors":[{"name":"qdleader","username":"qdleader","email":"yk4545945@163.com","commits":1,"url":"https://github.com/qdleader"}],"changelog":[{"hash":"b62ca1fcbdbabd49c9914b486982b403c3c04a60","time":1741916331000,"email":"yk4545945@163.com","author":"qdleader","message":"docs: 添加JS输出类及前置自增与后置自增示例"}]},"filePathRelative":"服务端/前端要懂得部分Nginx/1华为HECS云服务器配置nginx.md"}');export{p as comp,o as data};
