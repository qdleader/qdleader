import{_ as n,e as a,f as p,o as e}from"./app-Dw20wKhM.js";const t={};function l(o,s){return e(),a("div",null,s[0]||(s[0]=[p(`<h1 id="provide-和-inject-是响应式数据吗" tabindex="-1"><a class="header-anchor" href="#provide-和-inject-是响应式数据吗"><span>provide 和 inject 是响应式数据吗?</span></a></h1><h2 id="vue-provide-inject-详细介绍" tabindex="-1"><a class="header-anchor" href="#vue-provide-inject-详细介绍"><span>Vue Provide / Inject 详细介绍</span></a></h2><div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre><code><span class="line">通常，当我们需要从父组件向子组件传递数据时，我们使用 props。想象一下这样的结构：有一些深度嵌套的组件，而深层的子组件只需要父组件的部分内容。在这种情况下，如果仍然将 prop 沿着组件链逐级传递下去，可能会很麻烦。</span>
