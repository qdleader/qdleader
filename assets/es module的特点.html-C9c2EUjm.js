import{_ as n,e,f as a,o as l}from"./app-BTXTvCFM.js";const i={};function d(p,s){return l(),e("div",null,s[0]||(s[0]=[a(`<h1 id="es-module的特点" tabindex="-1"><a class="header-anchor" href="#es-module的特点"><span>es module的特点</span></a></h1><p>ES6 Module 静态的，不能放在块级作用域内，代码发生在编译时。 ES6 Module 的值是动态绑定的，可以通过导出方法修改，可以直接访问修改结果。 ES6 Module 可以导出多个属性和方法，可以单个导入导出，混合导入导出。 ES6 模块提前加载并执行模块文件，</p><h2 id="静态语法" tabindex="-1"><a class="header-anchor" href="#静态语法"><span>静态语法</span></a></h2><p>ES6 module 的引入和导出是静态的，import 会自动提升到代码的顶层 ，import , export 不能放在块级作用域或条件语句中。</p><h2 id="执行特性" tabindex="-1"><a class="header-anchor" href="#执行特性"><span>执行特性</span></a></h2><p>ES6 module 和 Common.js 一样，对于相同的 js 文件，会保存静态属性。 但是与 Common.js 不同的是 ，CommonJS 模块同步加载并执行模块文件，ES6 模块提前加载并执行模块文件，ES6 模块在预处理阶段分析模块依赖，在执行阶段执行模块，两个阶段都采用深度优先遍历，执行顺序是子 -&gt; 父。 如：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">main.js</span>
