import{_ as n,e as s,f as a,o as i}from"./app-Dw20wKhM.js";const l={};function d(t,e){return i(),s("div",null,e[0]||(e[0]=[a(`<h2 id="_1-单文件组件文件的大小写" tabindex="-1"><a class="header-anchor" href="#_1-单文件组件文件的大小写"><span>1.单文件组件文件的大小写</span></a></h2><blockquote><p>单文件组件的文件名应该要么始终是单词大写开头 (PascalCase)，要么始终是横线连接 (kebab-case)。我们推荐大写开头</p></blockquote><h3 id="bad" tabindex="-1"><a class="header-anchor" href="#bad"><span>bad:</span></a></h3><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">components/</span>
