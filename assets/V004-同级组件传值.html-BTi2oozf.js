import{_ as n,c as e,a as l,o as i}from"./app-D_ZNEwCJ.js";const a={};function t(d,s){return i(),e("div",null,s[0]||(s[0]=[l(`<h1 id="v004-同级组件传值" tabindex="-1"><a class="header-anchor" href="#v004-同级组件传值"><span>V004-同级组件传值</span></a></h1><p>1.如果是兄弟组件，可通过父元素作为中间组件进行传值</p><p>1.2 $emit传值，props接收</p><p>使用$emit将child1.vue的值给父组件，父组件将值传给child2.vue,child2.vue使用props接收</p><p>parent.vue</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">&lt;template&gt;</span>
...
<span class="line">&lt;/script&gt;</span>
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,19)]))}const c=n(a,[["render",t],["__file","V004-同级组件传值.html.vue"]]),v=JSON.parse('{"path":"/%E5%89%8D%E7%AB%AF%E9%9D%A2%E8%AF%95/vue%E7%AF%87/V004-%E5%90%8C%E7%BA%A7%E7%BB%84%E4%BB%B6%E4%BC%A0%E5%80%BC.html","title":"V004-同级组件传值","lang":"zh-CN","frontmatter":{},"headers":[],"git":{"updatedTime":1735538705000,"contributors":[{"name":"qdleader","username":"qdleader","email":"yk4545945@163.com","commits":1,"url":"https://github.com/qdleader"}]},"filePathRelative":"前端面试/vue篇/V004-同级组件传值.md"}');export{c as comp,v as data};
