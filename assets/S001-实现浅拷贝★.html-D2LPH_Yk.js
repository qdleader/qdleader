import{_ as s,c as a,a as n,o as i}from"./app-DmMObJTC.js";const l={};function c(t,e){return i(),a("div",null,e[0]||(e[0]=[n(`<h1 id="s001-实现浅拷贝★" tabindex="-1"><a class="header-anchor" href="#s001-实现浅拷贝★"><span>S001-实现浅拷贝★</span></a></h1><h2 id="_01-实现浅拷贝" tabindex="-1"><a class="header-anchor" href="#_01-实现浅拷贝"><span>01.实现浅拷贝</span></a></h2><p>如果一个变量复制一个对象，那么两者的值会是同一个引用，其中一个改变，另一方也会相应改变。针对引用类型我们需要实现数据的拷贝。</p><p>1.用...实现</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">const copy = {...{x:1}}</span>
