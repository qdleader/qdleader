import{_ as l,e as i,f as p,g as a,h as t,o as c}from"./app-BTXTvCFM.js";const o={};function d(n,s){return c(),i("div",null,[s[1]||(s[1]=p(`<h1 id="vue3-中常见的事件修饰符" tabindex="-1"><a class="header-anchor" href="#vue3-中常见的事件修饰符"><span>vue3 中常见的事件修饰符</span></a></h1><p>vue3中的事件修饰符跟vue2是一样的。。。我们在这再过一下常用的的吧</p><p>（１）. stop：阻止冒泡（通俗讲就是阻止事件向上级DOM元素传递）</p><p>.stop</p><div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre><code><span class="line"><span class="token operator">&lt;</span>div @click<span class="token punctuation">.</span>stop<span class="token operator">=</span><span class="token string">&quot;doS&quot;</span><span class="token operator">&gt;</span></span>
