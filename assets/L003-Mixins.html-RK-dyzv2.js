import{_ as n,c as e,a as i,o as a}from"./app-Dgmug7RJ.js";const l={};function c(d,s){return a(),e("div",null,s[0]||(s[0]=[i(`<p>#mixins</p><blockquote><p>less允许我们将已有的class和id的样式应用到另一个不同的选择器上。</p></blockquote><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">#circle {</span>
