import{_ as s,c as n,o as e,a}from"./app-Bul2w5Pu.js";const l={},i=a(`<h1 id="cold-003判断一个对象有环引用" tabindex="-1"><a class="header-anchor" href="#cold-003判断一个对象有环引用"><span>cold-003判断一个对象有环引用</span></a></h1><h2 id="判断一个对象有环引用" tabindex="-1"><a class="header-anchor" href="#判断一个对象有环引用"><span>判断一个对象有环引用</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">var obj = {</span>
