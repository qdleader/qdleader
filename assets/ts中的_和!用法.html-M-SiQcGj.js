import{_ as s,c as n,a,o as l}from"./app-a54uVf1G.js";const i={};function t(c,e){return l(),n("div",null,[...e[0]||(e[0]=[a(`<p>?用法</p><p>除了表示可选参数外，常用于防御性编程</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">const a = fetch(...) || {}		// 假设a是从后端拿到的一个对象类型数据</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>由于对null与undefined用 ! 操作符时都会产生true的结果， 所以用两个感叹号的作用就在于， 如果设置了o中flag的值（非 null/undefined/0&quot;&quot;/等值），自然test就会取跟o.flag一样的值； 如果没有设置，test就会默认为false，而不是 null或undefined。</p>`,13)])])}const r=s(i,[["render",t]]),p=JSON.parse('{"path":"/Typescript/ts%E4%B8%AD%E7%9A%84_%E5%92%8C!%E7%94%A8%E6%B3%95.html","title":"","lang":"zh-CN","frontmatter":{},"git":{"updatedTime":1756451399000,"contributors":[{"name":"qdleader","username":"qdleader","email":"yk4545945@163.com","commits":1,"url":"https://github.com/qdleader"}],"changelog":[{"hash":"ab677e2904c940d3113887bfe392bf6d5a740443","time":1756451399000,"email":"yk4545945@163.com","author":"qdleader","message":"feat: 添加七夕情人节主题页面"}]},"filePathRelative":"Typescript/ts中的?和!用法.md"}');export{r as comp,p as data};
