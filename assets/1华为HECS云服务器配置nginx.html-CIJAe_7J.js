import{_ as e,e as s,f as a,o as i}from"./app-Dw20wKhM.js";const r={};function l(t,n){return i(),s("div",null,n[0]||(n[0]=[a(`<h1 id="_1华为hecs云服务器配置nginx" tabindex="-1"><a class="header-anchor" href="#_1华为hecs云服务器配置nginx"><span>1华为HECS云服务器配置nginx</span></a></h1><h2 id="一、安装开发工具和依赖库" tabindex="-1"><a class="header-anchor" href="#一、安装开发工具和依赖库"><span>一、安装开发工具和依赖库</span></a></h2><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">yum <span class="token parameter variable">-y</span> <span class="token function">install</span> <span class="token function">make</span> zlib zlib-devel gcc-c++ libtool  openssl openssl-devel</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><p>上面命令，用于在yum软件包管理器中安装一些开发工具和依赖库。命令中各个参数的含义如下：</p><p>yum：是Linux系统常用的软件包管理工具； -y：表示在安装过程中遇到提示时默认选择&quot;yes&quot;，不需要手动确认； install：表示安装软件包； make：是一个构建工具，能够自动化地进行编译程序等操作； zlib、zlib-devel：都是提供数据压缩和解压功能的开发库，程序在编译时通常需要这两个库的支持； gcc-c++：是C++编译器，可以编译C++程序； libtool：是一个构建工具，在Linux平台上使用较多，能够简化动态库、静态库的构建流程； openssl、openssl-devel：是一个开源的加密库，提供了很多加密和解密函数。</p><h2 id="二、安装pcre" tabindex="-1"><a class="header-anchor" href="#二、安装pcre"><span>二、安装PCRE</span></a></h2><p>在nginx中，PCRE库被用来解析和匹配HTTP请求的URL、header、body等内容，并进行相关的操作，如重定向、路由转发、用户身份验证等。Nginx使用PCRE库能够实现更加灵活和高效的请求匹配和处理，同时也能节省开发者的时间和精力，提高Web应用的性能。因此，可将PCRE视为Nginx的一个重要组件。</p><h4 id="_1、进入-usr-local-src-文件夹下执行命令下载pcre8-45压缩包。" tabindex="-1"><a class="header-anchor" href="#_1、进入-usr-local-src-文件夹下执行命令下载pcre8-45压缩包。"><span>1、进入/usr/local/src/文件夹下执行命令下载pcre8.45压缩包。</span></a></h4><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"> <span class="token builtin class-name">cd</span> /usr/local/src/</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2、解压" tabindex="-1"><a class="header-anchor" href="#_2、解压"><span>2、解压</span></a></h4><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">tar</span> zxvf pcre-8.45.tar.gz</span>
<span class="line"></span>
<span class="line"></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2、编译安装" tabindex="-1"><a class="header-anchor" href="#_2、编译安装"><span>2、编译安装</span></a></h4><p>进入nginx-1.23.4文件夹输入下面命令编译安装。</p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token builtin class-name">cd</span> nginx-1.23.4</span>
