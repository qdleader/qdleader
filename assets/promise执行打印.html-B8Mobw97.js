...
<span class="line"><span class="token number">5</span></span>
<span class="line"><span class="token number">3</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="重点解析" tabindex="-1"><a class="header-anchor" href="#重点解析"><span>重点解析</span></a></h2><p>执行 promise.then 方法中的回调函数，输出 3。 接着执行 promise.catch 方法中的回调函数，由于 Promise 已经被解决该回调函数不会被执行。</p>`,9)]))}const o=s(l,[["render",t]]),u=JSON.parse('{"path":"/%E5%89%8D%E7%AB%AF%E9%9D%A2%E8%AF%95/js%E7%B1%BB/promise%E7%B1%BB/promise%E6%89%A7%E8%A1%8C%E6%89%93%E5%8D%B0.html","title":"promise执行打印","lang":"zh-CN","frontmatter":{},"git":{"updatedTime":1751593802000,"contributors":[{"name":"qdleader","username":"qdleader","email":"yk4545945@163.com","commits":1,"url":"https://github.com/qdleader"}],"changelog":[{"hash":"3ed7ece53189e584b32f934a400de1f057911f25","time":1751593802000,"email":"yk4545945@163.com","author":"qdleader","message":"docs(es6): 添加ES2025模式匹配文档示例"}]},"filePathRelative":"前端面试/js类/promise类/promise执行打印.md"}');export{o as comp,u as data};
