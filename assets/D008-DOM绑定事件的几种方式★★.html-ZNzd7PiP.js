import{_ as e,c as s,a as l,o as a}from"./app-BJH5QZKa.js";const i={};function t(d,n){return a(),s("div",null,n[0]||(n[0]=[l(`<h1 id="d008-dom绑定事件的几种方式★★" tabindex="-1"><a class="header-anchor" href="#d008-dom绑定事件的几种方式★★"><span>D008-DOM绑定事件的几种方式★★</span></a></h1><h2 id="_1-在dom元素中直接绑定" tabindex="-1"><a class="header-anchor" href="#_1-在dom元素中直接绑定"><span>1.在DOM元素中直接绑定</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">&lt;input type=&quot;button&quot; onclick=&quot;fn()&quot;/&gt;</span>
